	        ...
	        for(int i=0;i<=n-1;i++)
{
  ...
  empBean.setExp(sc.nextInt());
	 empArray[i]=empBean;
	        ...
	        FileOutputStream fos=new FileOutputStream("D:/mou.txt");
	...
	{
		FileInputStream fis=new FileInputStream("D:/mou.txt");
	...
	public void update()throws Exception
	{
 	   ...
 	   System.out.println("experience= "+ emp.getExp());
         ...
         FileOutputStream fs=new FileOutputStream("D:/mou.txt");
