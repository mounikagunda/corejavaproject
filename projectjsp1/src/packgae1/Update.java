...
public class Update extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		catch(Exception e)
		{
		 ...
		 try{
			 PreparedStatement ps=connection.prepareStatement("update employee set employeeName=?,employeeSalary=?,employeeLocation=?,employeeExp=?,employeeLoan=? where employeeId=?");
